            ...
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-primary">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" action="#" method="POST">
                        <div>
                            <label htmlFor="email" className="block text-sm font-medium leading-6 text-red-50">
                                Email address
                            </label>
                            <div className="mt-2">
                                <input
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                <label htmlFor="password" className="block text-sm font-medium leading-6 text-red-50">
                                    Password
                                </label>
